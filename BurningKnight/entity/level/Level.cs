...
namespace BurningKnight.entity.level {
	public abstract class Level : SaveableEntity {
		static Level() {
			...
			if (!MaskShader.IsCompiled()) throw new GdxRuntimeException("Couldn't compile shader: " + MaskShader.GetLog());
		}
		...
		public static Color[] Colors =
			{Color.ValueOf("#0e071b"), Color.ValueOf("#391f21"), Color.ValueOf("#5d2c28"), Color.ValueOf("#1a1932"), Color.ValueOf("#272727"), Color.ValueOf("#1a1932"), Color.ValueOf("#3b1443"), Color.ValueOf("#92a1b9")};

		public Room Entrance;
		public Room Exit;
		public const Vector2[] NEIGHBOURS8V = {
...
public const Rectangle[] COLLISIONS = {
internal new Rectangle(4, 4, 8, 8),
internal new Rectangle(4, 4, 8, 12),
internal new Rectangle(4, 4, 12, 8),
internal new Rectangle(4, 4, 12, 12),
internal new Rectangle(4, 0, 8, 12),
internal new Rectangle(4, 0, 8, 16),
internal new Rectangle(0, 0, 12, 16),
internal new Rectangle(4, 0, 12, 16),
internal new Rectangle(0, 4, 12, 8),
internal new Rectangle(0, 4, 12, 12),
internal new Rectangle(0, 4, 16, 8),
internal new Rectangle(0, 4, 16, 12),
internal new Rectangle(0, 0, 12, 12),
internal new Rectangle(0, 0, 12, 16),
internal new Rectangle(0, 0, 16, 12),
internal new Rectangle(0, 0, 16, 16)
};
