using System;
using Desktop.integration.discord.DiscordRPC.Exceptions;
using Desktop.integration.discord.DiscordRPC.IO;
using Desktop.integration.discord.DiscordRPC.Logging;
using Desktop.integration.discord.DiscordRPC.Message;
using Desktop.integration.discord.DiscordRPC.Registry;
using Desktop.integration.discord.DiscordRPC.RPC;
using Desktop.integration.discord.DiscordRPC.RPC.Commands;
...
namespace Desktop.integration.discord.DiscordRPC
{
	...
	public sealed class DiscordRpcClient : IDisposable
	{
		...
		/// <summary>
		/// Represents if the client has been <see cref="Initialize"/>DiscordRpcClient
		/// </summary>
		...
		/// <summary>
		/// Dequeues a single message from Discord and processes it. No events will be invoked.
		/// </summary>
		/// <returns>Returns a single message that was dequeued from Discord</returns>
