...
using Desktop.integration.discord.DiscordRPC.Helper;
...
namespace Desktop.integration.discord.DiscordRPC
{
	...
	public class RichPresence
	{
        ...
        /// <summary>
        /// Attempts to call <see cref="StringTools.GetNullOrString"/> on the string and return the result, if its within a valid length.
        /// </summary>
