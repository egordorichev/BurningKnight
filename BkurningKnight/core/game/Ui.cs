...
using BurningKnight.core.entity.creature.player.fx;
...
namespace BurningKnight.core.game {
	public class Ui {
		...
		public Ui() {
			...
			Regions = { Graphics.GetTexture("ui-cursor-standart"), Graphics.GetTexture("ui-cursor-small"), Graphics.GetTexture("ui-cursor-rect"), Graphics.GetTexture("ui-cursor-corner"), Graphics.GetTexture("ui-cursor-sniper"), Graphics.GetTexture("ui-cursor-round-sniper"), Graphics.GetTexture("ui-cursor-cross"), Graphics.GetTexture("ui-cursor-nt"), null };
		}
