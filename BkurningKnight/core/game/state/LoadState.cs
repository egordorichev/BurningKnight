...
namespace BurningKnight.core.game.state {
	public class LoadState : State {
		...
		private static List<string> Jokes = new List<>(Arrays.AsList("Please stand by", "Press X", "Generating trouble", "Looking cool", "Get em!", "Terraforming mars", "Dodge this!", "I think that knight wanted to say something", "Are we there yet?", "Generating secrets", "Hiding secrets", "I'm hungry", "/!\\ /!\\ /!\\", "Saving is important", "Cooling down", "Heating up", "Adding some drama", "Melee weapons can reflect bullets", "You better get digging", "QWERTY", "F2", "Generating generators", "Waking up", "Deleting the saves", "Preparing to start", "Looking for an excuse", "asdasdasd", "Automatically synchronizing cardinal grammeters", "Reducing sinusoidal repleneration", "Fromaging the bituminous spandrels", "Join our discord!", "Reticulating splines", "Calculating Math.PI", "Inventing the wheel", "Adding some oil", "Recruiting robot hamsters", "Generating buttons", "Installing deinstallers", "Thinking", "I like pizza", "That fight tho", "Be careful", "Almost RIP", "@egordorichev", "Dog food", "Always wear dry socks", "Its your lucky day", "Press F to pay respect", "Let's do this", "Let's go", "YOOOOOO", "Go go go", "Делаем вид что это что-то значит", "Loading terrain", "Building terrain", "Googling", "Help me", "SOS", "Are we lost?", "Spooooky", "On fire", "It's magic time", "That joke tho", "Settings things on fire", "Preparing to explode", "Installing linux", "Erasing data", "Generating a joke"));
		private bool Second;
		private bool Third;
		private bool RunM;
		private bool Error;
