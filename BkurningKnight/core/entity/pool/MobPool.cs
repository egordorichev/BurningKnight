...
using BurningKnight.core.entity.creature.mob.blood;
...
using BurningKnight.core.entity.creature.mob.library;
using BurningKnight.core.entity.creature.mob.tech;
using BurningKnight.core.entity.level.blood;
using BurningKnight.core.entity.level.levels.desert;
...
using BurningKnight.core.entity.level.levels.library;
...
namespace BurningKnight.core.entity.pool {
	public class MobPool {
		...
		public Void InitForFloor() {
			Clear();
			bool Chaos = Random.GetSeed().Equals("CHAOS");
			...
			if (Chaos || Dungeon.Level is IceLevel) {
				Add(0.15f, 1, BurningMan.GetType());
			} 
